...
extern void array_destroy(array_t ** a, free_func_t free_func, freep_func_t freep_func);
extern void array_clean(array_t * a, free_func_t free_func, freep_func_t freep_func);
extern void array_append(array_t * a, void * obj);
extern void array_insert(array_t * a, void * obj, int position);
extern bool array_del(array_t * a, void * obj);
void array_pop(array_t * a);
//extern void array_del_no_lock(array_t * a, void *obj);
extern void array_resize(array_t * a, int count);
extern void array_preappend(array_t * a, const int app_count);
